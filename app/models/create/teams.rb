module Create
  class Teams
    ...
    @teams = [
      ...
      { id: 4,    name: 'Blue Jays',        city: 'Toronto',          espn_abbr: 'TOR',   baseball_abbr: 'TOR',  mlb_abbr: 'bluejays',    stadium: 'Rogers Centre',             fangraph_id: 14,      zipcode: '14203', timezone: 0 },
      { id: 5,    name: 'Braves',           city: 'Atlanta',          espn_abbr: 'ATL',   baseball_abbr: 'ATL',  mlb_abbr: 'braves',      stadium: 'SunTrust Park',            fangraph_id: 16,      zipcode: '30339',   timezone: 0 },
      ...
      { id: 10,   name: 'Dodgers',          city: 'Los Angeles',      espn_abbr: 'LAD',   baseball_abbr: 'LAD',  mlb_abbr: 'dodgers',     stadium: 'Dodger Stadium',          fangraph_id: 22,      zipcode: '90012',   timezone: -3 },
