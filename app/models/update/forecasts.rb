module Update
  class Forecasts
    ...
    def update_table(game)
      ...
      all_forecasts = [forecast_prev_one.first, forecast_prev_two.first, forecast_one.first, forecast_two.first, forecast_three.first, forecast_four.first, forecast_after_one.first]
    ...
    private
      ...
      @@urls = [
        ...
        "https://api.weather.com/v1/location/14203%3A4%3AUS/forecast/hourly/48hour.json?units=e&language=en-US&apiKey=6532d6454b8aa370768e63d6ba5a832e",
